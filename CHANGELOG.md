...
- `get_references_to(address, limit=100)`: capped (the largest real result was 43k chars). When cut off, a note gives the total and the ten functions with the most references.
